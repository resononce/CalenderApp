...
function setDay(value, timeEnd, day, jClass) {
        ...
        success: function (result) {
            if (result.status == true) {
                ...
                $.each(result.simpleEvents, function (index, value) {
                    if (value.day == 0) {
                        setDay(value.time, value.timeEnd, 's', ' success')
                    } else if (value.day == 1) {
                        setDay(value.time, value.timeEnd, 'm', ' success')
                    } else if (value.day == 2) {
                        setDay(value.time, value.timeEnd, 't', ' success')
                    } else if (value.day == 3) {
                        setDay(value.time, value.timeEnd, 'w', ' success')
                    } else if (value.day == 4) {
                        setDay(value.time, value.timeEnd, 'th', ' success')
                    } else if (value.day == 5) {
                        setDay(value.time, value.timeEnd, 'f', ' success')
                    } else if (value.day == 6) {
                        setDay(value.time, value.timeEnd, 'sa', ' success')
                    }
                });
